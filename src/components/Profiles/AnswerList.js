...
const AnswerList = props => {
  ...
  return (
    <div className="u-medium-padding-horizontal u-medium-padding-vertical u-display-flex u-flex-column c-box u-medium-margin-top u-has-border">
                    ...
                    <Popover.Content>
                      ...
                      <div className="u-display-flex">
                        ...
                        <div className="u-popover-padding__left">
                          ...
                          {/* <b>{console.log(props.partials)}</b> */}
                        </div>
